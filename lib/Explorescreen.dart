            ...
            child: Column(
              children: [
                SizedBox(
                  ...
                  width: double.infinity,
                  child:
                      _userList.where((user) => user.city == "child").isEmpty
                          ? const Center(child: CircularProgressIndicator())
                          : GridView.builder(
                            itemCount:
                                _userList
                                    .where((user) => user.city == "child")
                                    .length,
                            gridDelegate:
                                const SliverGridDelegateWithMaxCrossAxisExtent(
                                  maxCrossAxisExtent: 200,
            ...
            child: Column(
              children: [
                ...
                SizedBox(
                  ...
                  width: double.infinity,
                  child:
                      _userList.where((user) => user.city == "male").isEmpty
                          ? const Center(child: CircularProgressIndicator())
                          : GridView.builder(
                            itemCount:
                                _userList
                                    .where((user) => user.city == "male")
                                    .length,
                            gridDelegate:
                                const SliverGridDelegateWithMaxCrossAxisExtent(
                                  maxCrossAxisExtent: 200,
            ...
            child: Column(
              children: [
                SizedBox(
                  ...
                  width: double.infinity,
                  child:
                      _userList.where((user) => user.city == "female").isEmpty
                          ? const Center(child: CircularProgressIndicator())
                          : GridView.builder(
                            itemCount:
                                _userList
                                    .where((user) => user.city == "female")
                                    .length,
                            gridDelegate:
                                const SliverGridDelegateWithMaxCrossAxisExtent(
                                  maxCrossAxisExtent: 200,
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Text(
                              "L",
                              style:
                                  container == 2 ? producttxtwhite : producttxt,
                            ),
                          ),
                        ),
                      ),
